...
def test_template_validation():
    ...
    assert validate_output_template("%(playlist)s/%(title)s.%(ext)s")
    assert not validate_output_template("plain-name.mp4")
    assert not validate_output_template("../%(title)s.%(ext)s")
    assert not validate_output_template(r"folder\..\%(title)s.%(ext)s")
    assert not validate_output_template(r"C:\outside\%(title)s.%(ext)s")
    assert not validate_output_template("/outside/%(title)s.%(ext)s")
